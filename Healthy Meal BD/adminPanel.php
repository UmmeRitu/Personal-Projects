...
<!--==================================Sign up form================================================-->
			<section class="signup">
              ...
              <form method="POST" class="register-form" id="login-form" enctype="multipart/form-data"> 
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="pname" placeholder="Product Name" required="required"/>
                            </div>
                            <div class="form-group">
                                <label for="your_name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="des" id="pname" placeholder="Description" required="required"/>
                            </div>
                            <div class="form-group">
                                <label for="your_name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="price" id="pname" placeholder="Price" required="required"/>
                            </div>
                            <div class="form-group">
                                <label for="your_name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="cat" id="pname" placeholder="catagory" required="required"/>
                            </div>
     ...
     if(isset($_POST['submit'])) {	
        ...
        $cat = $_POST['cat'];
         ...
         $sql = "INSERT INTO `meal`(`name`, `des`, `price`, `pic`, `cata`) VALUES ('$name','$des','$price','$imagetmp','$cat')";
         $result = mysqli_query($conn, $sql);          
       
         
              echo '<h4 style="color:green">uploaded</h4>';
